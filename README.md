...
1. `swift build`
1. `.build/debug/2019.10.28ARKitura`
...
#### Kubernetes
To deploy your application to your Kubernetes cluster, run `helm install --name myapp .` in the `/chart/2019.10.28ARKitura` directory. You need to make sure you change the `repository` variable in your `chart/2019.10.28ARKitura/values.yaml` file points to the docker image containing your runnable application.
